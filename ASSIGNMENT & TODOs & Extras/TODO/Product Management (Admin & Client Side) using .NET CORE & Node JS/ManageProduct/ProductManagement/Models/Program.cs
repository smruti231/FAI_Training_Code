    ...
    class Program
        ...
        static void Main(string[] args)
            ...
            while (true)
                ...
                Console.WriteLine("6. Add the csv File");
                ...
                try
                    ...
                    switch (choice)
                        ...
                        case "5":
                            ...
                            break;
                        case "6":
                            ImportDataFromCsv(productManager);
                            break;
                        case "7":
                            Environment.Exit(0);
                            break;
        ...
        private static void ImportDataFromCsv(IProductManager productManager)
            {
            ...
            try
                ...
                using (var reader = new StreamReader(csvFilePath))
                    ...
                    while (!reader.EndOfStream)
                        ...
                        if (values.Length != 4)
                            {
                            Console.WriteLine("Invalid CSV format. Each line should contain 4 values: Name,Price,Rating,Stock");
                            return;
                            }
